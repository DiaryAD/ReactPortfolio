                    ...
                    <div className="grid grid-cols-2 gap-2 text-center lg:grid-cols-6">
                        ...
                        <div className="flex items-center justify-center">
                            ...
                            >
                                ...
                                <svg
                                    className="hi-solid hi-code-bracket-square inline-block size-6 text-blue-600 dark:text-blue-500"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 32 32"
                                    fill="currentColor"
                                    aria-hidden="true">
                                    <path
                                        d="M18.6789 15.9759C18.6789 14.5415 17.4796 13.3785 16 13.3785C14.5206 13.3785 13.3211 14.5415 13.3211 15.9759C13.3211 17.4105 14.5206 18.5734 16 18.5734C17.4796 18.5734 18.6789 17.4105 18.6789 15.9759Z"></path>
                                    <path
